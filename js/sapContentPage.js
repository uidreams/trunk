...
(function () {
    ...
    var R = {
        initialize: function () {
            ...
            this.reset();
            var a = this.getPages(), i;
            for (i = 0; i < a.length; i++) {
                this.ContentPage.prepare(a[i]);
            }
            if (typeof(ga) != "undefined")
                ga('send','event', 'sap', 'init');
            
            this.Request.fetchToken(this.handleFetchTokenResponse.bind(this, a));
        },
        handleFetchTokenResponse: function (a) {
            var i;
            for (i = 0; i < a.length; i++) {
        ...
        ContentPage: {
            prepare: function (o) {
                ...
                var o = R.Util.findParentByClassName(n, "sapCpContentPage"),
                    m = R.Node.getAllWithClassName(o, "sapCpWidgetMandatoryMissing"), h = (m.length > 0);
                ...
                var w = this.getWidgets(o), W, A = [], m, M = false, i = false, I;
                for (I = 0; I < w.length; I++) {
                    W = w[I];
                ...
                var buttonSelector = R.ButtonWidget.buttonSelector(o);
                if(buttonSelector.length > 0) {
                    buttonSelector[0].disabled = false;
                }
                ...
                var t = R.Setting.get(o, "test-mode"), p = R.Setting.get(o, "productive");
                return (t && p);
        ...
        InputWidget: {
            prepare: function (i) {
                var I = R.Widget.isMandatory(i), a, d, D, b;
                ...
                var D = R.Node.getAllWithClassName(d, "sapCpDropDown"), o, i;
                ...
                var d = R.Setting.get(y, "dropdowntype"), Y = d.split("-"), i, a, o = new Date(), b = o.getFullYear(),
                    e, I;
                if (Y.length === 4) {
                    i = (parseInt(Y[2], 10) || 0);
                    a = (parseInt(Y[3], 10) || 0);
                ...
                var I = R.Node.getFirstWithClassName(i, "sapCpInput"),
                    ...
                    d = R.Node.getFirstWithClassName(i, "sapCpDatePicker"),
                    D = R.Node.getFirstWithClassName(i, "sapCpDropDown"), a;
                if (!v) {
                    return;
                }
                if (I) {
                ...
                var i = e.target, I = R.Util.findParentByClassName(i, "sapCpInputWidget");
                if (i.value) {
                ...
                var s = D.selectedOptions[0].value, S = m.selectedOptions[0].value, a = y.selectedOptions[0].value,
                    i = (parseInt(s, 10) || 0), b = (parseInt(S, 10) || 0), e = (parseInt(a, 10) || 0),
                    o = new Date(e, b, 0), f = o.getDate(), O = D.options.length, g, I;
                if (i > f) {
                ...
                var I = R.Widget.isMandatory(i), o = R.Node.getFirstWithClassName(i, "sapCpInput"),
                    a = R.Node.getFirstWithClassName(i, "sapCpCheckBox"),
                    d = R.Node.getFirstWithClassName(i, "sapCpDatePicker"),
                    D = R.Node.getFirstWithClassName(i, "sapCpDropDown"), b, s, e;
                if (o) {
                ...
                var A = {WidgetKeyHash: R.Setting.get(i, "key"), WidgetValueKeyHash: "", Value: s};
                return A;
            }
        },
        CheckBoxWidget: {
            prepare: function (o) {
                var i = R.Widget.isMandatory(o), a;
                if (!i) {
                    return;
                }
                ...
                var o = e.target, a = R.Util.findParentByClassName(o, "sapCpCheckBoxWidget");
                if (o.checked) {
                    R.Widget.toggleMissingMandatory(a, false);
                }
                R.ContentPage.checkMissingMandatoryFieldsLabel(a);
            }, collectAnswer: function (o) {
                var i = R.Widget.isMandatory(o), a = o.getElementsByTagName("input")[0], b = false;
                if (a) {
                    b = a.checked;
                }
                if (i && !b) {
                ...
                var A = {WidgetKeyHash: R.Setting.get(o, "key"), WidgetValueKeyHash: "", Value: (b ? "X" : "")};
                return A;
            }
        },
        NoteWidget: {
            collectAnswer: function (n) {
                var w = R.Widget.isMandatory(n), t = n.getElementsByTagName("textarea"), N;
                if (t[0]) {
                    N = t[0].value;
                }
                if (w && !N) {
                ...
                var a = {WidgetKeyHash: R.Setting.get(n, "key"), WidgetValueKeyHash: "", Value: N};
                return a;
            }
        },
        DownloadWidget: {
            prepare: function (d) {
                var w = R.Widget.isMandatory(d), a;
                if (!w) {
                    return;
                }
                ...
                var o = e.target, d = R.Util.findParentByClassName(o, "sapCpDownloadWidget");
                if (o.checked) {
                    R.Widget.toggleMissingMandatory(d, false);
                }
                R.ContentPage.checkMissingMandatoryFieldsLabel(d);
            }, collectAnswer: function (d) {
                var w = R.Widget.isMandatory(d), a = d.getElementsByTagName("input"), b = false;
                if (a[0]) {
                    b = a[0].checked;
                }
                if (w && !b) {
                ...
                var A = {WidgetKeyHash: R.Setting.get(d, "key"), WidgetValueKeyHash: "", Value: (b ? "X" : "")};
                return A;
            }
        },
        InteractionWidget: {
            prepare: function (i) {
                var w = R.Widget.isMandatory(i), a;
                if (!w) {
                    return;
                }
                a = i.getElementsByTagName("input");
                ...
                var o = e.target, i = R.Util.findParentByClassName(o, "sapCpInteractionWidget");
                if (o.checked) {
                    R.Widget.toggleMissingMandatory(i, false);
                }
                R.ContentPage.checkMissingMandatoryFieldsLabel(i);
            }, collectAnswer: function (i) {
                var w = R.Widget.isMandatory(i), a = i.getElementsByTagName("input"), b = false;
                if (a[0]) {
                    b = a[0].checked;
                }
                if (w && !b) {
                ...
                var A = {WidgetKeyHash: R.Setting.get(i, "key"), WidgetValueKeyHash: "", Value: (b ? "X" : "")};
                return A;
            }
        },
        ButtonWidget: {
            buttonSelector: function (b) {
                return b.querySelectorAll('.sap-submit');
            },
            prepare: function (b) {
                var B;
                ...
                var b = e.target, B = R.Util.findParentByClassName(b, "sapCpButtonWidget");
                if (e.preventDefault) {
                    e.preventDefault();
                }
                ...
                var a;
                if (b === o) {
                    a = {WidgetKeyHash: R.Setting.get(b, "key"), WidgetValueKeyHash: "", Value: "X"};
                }
                return a;
        ...
        Result: {
            sendOpen: function (o, f) {
                var p = (R.Setting.get(o, "prefill-data") === "true"), O = R.Result.buildOpen(o, p);
                ...
                var a = R.Util.findParentByClassName(o, "sapCpContentPage"), s = R.Result.buildSubmit(a, o), v = true;
                ...
                if (o === C.BasePath) {o = C.BasePath.replace(/\/$/, "");}
                var r = {ResultEvent: e, ContentPageKeyHash: R.Setting.get(o, "key"), Url: R.Util.getCurrentUrl()};
                ...
                $(o).removeClass('before-submitting');
        ...
        Request: {
            build: function (m, p) {
                ...
                if (h.setRequestHeader) {
                    ...
                    h.setRequestHeader(C.CSRFTokenHeader, (c || "Fetch"));
                    return true;
                }
                return false;
            ...
            }, fetchToken: function (f, u) {
                var h = (u ? "GET" : "HEAD"), H = this.build(h, C.BasePath);
                this.send(H, null, function () {
                    if (H.getResponseHeader) {
                        var n = H.getResponseHeader(C.CSRFTokenHeader);
                        if (n) {
                            c = n;
                        }
                    }
                    ...
                    if (!u) {
                        R.Request.fetchToken(f, true);
                        if (typeof(ga) != "undefined")
                            ga('send','event', 'sap', 'fetchToken_success');
                    } else {
                        R.Console.warn("Technical error occurred.");
                        if (typeof(ga) != "undefined")
                            ga('send','event', 'sap', 'fetchToken_fail');
                    }
                });
            }, postResult: function (r, f) {
                var s = C.BasePath + C.ResultHeadersPath, h = this.build("POST", s);
                this.send(h, r, function () {
                    var m = JSON.parse(h.responseText);
                    m = (m && m.d || m);
                    f(m);
                    if (typeof(ga) != "undefined")
                        ga('send','event', 'sap', 'login');
                }, function () {
                    var m = JSON.parse(h.responseText);
                    f(m);
                    R.Console.warn("Technical error occurred.");
        ...
        Util: {
            findParentByClassName: function (n, s) {
                ...
                for (var i = 0; i < q.length; i++) {
                    var P = q[i].split("="), n = decodeURIComponent(P[0]);
                    if (n === p) {
                ...
                var s = u.indexOf("/"), d = u.indexOf("."), p = u.indexOf("://");
                if (s === 0 || d === 0) {
                    return u;
                }
                if (p < 0 || s !== p + 1) {
